...
(custom-set-variables
 ...
 '(auto-indent-disabled-modes-list (quote (compilation-mode conf-windows-mode diff-mode inferior-ess-mode dired-mode eshell-mode markdown-mode fundamental-mode log-edit-mode makefile-gmake-mode org-mode snippet-mode texinfo-mode text-mode wl-summary-mode nil js-mode javascript-mode)))
 ...
 '(popwin:special-display-config (quote (("*grunt*" :width 20.0 :position right :noselect t) ("*RE-Builder*" :height 2 :position bottom) ("*run-current-file output*" :regexp nil :position bottom :noselect t :dedicated t :tail t) ("*Ido Completions*" :position bottom :noselect t) ("*Help*") ("*Completions*" :position bottom :noselect t) ("*vc-log*" :position bottom) ("*compilation*" :noselect t) ("*Occur*" :position bottom :noselect t))) nil nil "op")
