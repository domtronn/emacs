...
(custom-set-variables
 ...
 '(custom-safe-themes (quote ("82d2cac368ccdec2fcc7573f24c3f79654b78bf133096f9b40c20d97ec1d8016" "bb08c73af94ee74453c90422485b29e5643b73b05e8de029a6909af6a3fb3f58" "628278136f88aa1a151bb2d6c8a86bf2b7631fbea5f0f76cba2a0079cd910f7d" default)))
 ...
 '(popwin:special-display-config (quote (("*dirtree*" :position left :dedicated nil :stick t) ("*IBuffer*" :position bottom) ("*RE-Builder*" :height 2 :position bottom) ("*Ido Completions*" :position bottom :noselect t) ("*Help*") ("*Completions*" :position bottom :dedicated nil) ("*compilation*" :noselect t) ("*Occur*" :position bottom :noselect t))) nil nil "op")
 ...
 '(tabbar-ruler-excluded-buffers (quote ("*Messages*" "*Completions*" "*ESS*" "*dirtree*" "*Help*")))
...
(set-face-foreground (quote font-lock-comment-face) "#698b22")
(set-face-foreground (quote font-lock-comment-delimiter-face) "#496b22")
...
(custom-set-faces
 ...
 '(ac-etags-candidate-face ((t (:background "#99cc99" :foreground "grey20"))) t)
 '(ac-etags-selection-face ((t (:background "#698b22" :foreground "grey20"))) t)
 ...
 '(highlight-current-line-face ((t (:background "#efeff0"))))
 '(hs-face ((t nil)))
 ...
 '(mode-line ((t (:background "#e6e4fa" :foreground "#2d2d2d" :box (:line-width 4 :color "#635f92" :style released-button)))))
 '(mode-line-buffer-id ((t (:foreground "#635f92" :weight bold))))
 '(mode-line-emphasis ((t (:foreground "#99bb99" :slant italic :weight bold))))
 '(mode-line-inactive ((t (:inherit mode-line :background "#e6e4fa" :foreground "#2d2d2d" :weight normal))))
 ...
 '(tabbar-button ((t (:inherit tabbar-default :box (:line-width 1 :color "white" :style released-button) :height 1.0))))
 '(tabbar-default ((t (:inherit variable-pitch :background "#e6e4fa" :foreground "#535f92" :box (:line-width 4 :color "#635f92" :style released-button) :height 1.0))))
 '(tabbar-unselected ((t (:inherit nil :stipple nil :background "#6f6f7f" :foreground "#ffffff" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "apple" :family "Monaco"))))
 '(tabbar-unselected-modified ((t (:inherit tabbar-unselected :foreground "#bbecab" :weight bold)))))
