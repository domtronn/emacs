...
(custom-set-variables
 ...
 '(popwin:special-display-config (quote (("*grunt*" :width 20.0 :position right :noselect t) ("*RE-Builder*" :height 2 :position bottom) ("*run-current-file output*" :regexp nil :position bottom :noselect t :dedicated t :tail t) ("*Ido Completions*" :position bottom :noselect t) ("*Help*") ("*Completions*" :position bottom :noselect t) ("*vc-log*" :position top ) ("*compilation*" :noselect t) ("*Occur*" :position bottom :noselect t))) nil nil "op")
