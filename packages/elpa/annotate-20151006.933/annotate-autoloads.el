...

;;;### (autoloads nil "annotate" "annotate.el" (22038 8554 0 0))
...
(defvar annotate-integrate-marker " ANNOTATION: " "\
Marker that is written before every integrated annotation.")

(custom-autoload 'annotate-integrate-marker "annotate" t)
...
(autoload 'annotate-next-annotation "annotate" "\
Move point to the next annotation.

\(fn)" t nil)

(autoload 'annotate-previous-annotation "annotate" "\
...
(autoload 'annotate-integrate-annotations "annotate" "\
