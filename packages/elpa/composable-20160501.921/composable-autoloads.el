...

;;;### (autoloads nil "composable" "composable.el" (22312 21397 0
;;;;;;  0))
;;; Generated autoloads from composable.el

(defvar composable-mode nil "\
Non-nil if Composable mode is enabled.
See the command `composable-mode' for a description of this minor mode.")
...
See the command `composable-mark-mode' for a description of this minor mode.
...
;;;***

;;;### (autoloads nil nil ("composable-mark.el" "composable-pkg.el")
;;;;;;  (22312 21397 978323 0))
