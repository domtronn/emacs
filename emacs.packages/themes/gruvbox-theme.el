...
(custom-theme-set-faces
 ...
 '(rainbow-delimiters-unmatched-face ((t (:background nil :foreground "#fdf4c1"))))
  '(emms-browser-album-face ((t (:foreground "#fabd2f" :weight extra-light :height 1.1 :family "DejaVu Sans Mono"))))
 '(emms-browser-artist-face ((t (:foreground "#fb4934" :height 1.3 :family "DejaVu Sans Mono Extralight"))))
 '(emms-browser-track-face ((t (:foreground "#b8bb26" :height 1.0 :family "DejaVu Sans Mono"))))
 '(emms-playlist-track-face ((t (:foreground "#b8bb26"))))
